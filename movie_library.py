...
class MovieLibrary:
    ...
    def get_most_common_year(self):
        ...
        Find most common: The most_common(1) method returns a list with the single most common element,
        in the form of a tuple (year, frequency). The index [0][0] retrieves the year.
